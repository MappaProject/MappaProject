...
GPIO.setup(14, GPIO.OUT)                                              # Definition du port en sortie
...
print("\n+------------------/ Blink LED /------------------+")
print("|                                                 |")
print("| La LED doit etre reliee au GPIO 14 du Raspberry |")
print("|                                                 |")
print("+-------------------------------------------------+\n")
...
while i < nbrBlink :
    GPIO.output(14, True)                                              # Mise a 1 du GPIO 18 (+5V)
    time.sleep(tempsAllume)                                            # On attend le temps defini
    GPIO.output(14, False)                                             # Mise a zero du GPIO 18 (GND)
